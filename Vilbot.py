...
def GetBool():
    ...
    # Laske kuinka monta kertaa vastustaja on valinnut True ja False
    true_count = OpponentMoves.count(True)
    false_count = OpponentMoves.count(False)
    
    # Tee arvaus datan perusteella
